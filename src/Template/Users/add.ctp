                        ...
                        <div class="p-5">
                            ...
                            <fieldset>
                                ...
                                <div style="right:5%; position: absolute; margin-top: -4%;">
                                    <?= $this->Html->link('Volver', ['action' => 'index'], ['escape' => false, 'class' => 'btn btn-primary']); ?>
                                </div>
                                <?php
                                    ...
                                    echo $this->Form->control('password', ['label' => 'Contraseña', 'class' => 'form-control', 'placeholder' => 'Escriba la contraseña del usuario', 'required' => 'required']);
                                    echo $this->Form->control('confirm_password', ['label' => 'Repetir contraseña', 'class' => 'form-control', 'placeholder' => 'Escriba nuevamente la contraseña del usuario', 'type' => 'password', 'required' => 'required']);
